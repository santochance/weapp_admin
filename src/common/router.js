...
export const getRouterData = (app) => {
  const routerConfig = {
    '/': {
      component: dynamicWrapper(app, ['user', 'login', 'sort', 'region'], () => import('../layouts/BasicLayout')),
    },
    '/dashboard/analysis': {
    ...
    '/unit/unitGroups': {
      component: dynamicWrapper(app, ['content'], () => import('../routes/UnitGroup/UnitGroup')),
    },
    '/unit/units': {
    ...
    '/investors': {
      component: dynamicWrapper(app, ['content'], () => import('../routes/Investor/Investor')),
    },
    '/organizations': {
      component: dynamicWrapper(app, ['content'], () => import('../routes/Organization/Organization')),
    },
    '/participants': {
      component: dynamicWrapper(app, ['content'], () => import('../routes/Participant/Participant')),
    },
    '/news': {
    ...
    '/banners': {
      component: dynamicWrapper(app, ['content'], () => import('../routes/Banner/Banner')),
    },
