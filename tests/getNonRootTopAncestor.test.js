const { findTreeNode, getNonRootTopAncestor } = require('../src/utils/getNonRootTopAncestor');
...
const ancestor = getNonRootTopAncestor(flatList, rst);
console.log(JSON.stringify(ancestor, null, 2));
